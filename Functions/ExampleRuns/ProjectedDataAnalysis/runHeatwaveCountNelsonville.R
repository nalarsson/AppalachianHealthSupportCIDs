...
write.csv(hwcount.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/TwoDayHWNelsonvillehistorical.csv")

# write.csv(hwcount.df,
#           file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/DaysAbove90Nelsonvillehistorical.csv")
...
write.csv(hwcount.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/TwoDayHWNelsonvilleMC126.csv")
# write.csv(hwcount.df,
#           file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/DaysAbove90NelsonvilleMC126.csv")
...
write.csv(hwcount.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/TwoDayHWNelsonvilleEC126.csv")
# write.csv(hwcount.df,
#           file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/DaysAbove90NelsonvilleEC126.csv")
...
write.csv(hwcount.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/TwoDayHWNelsonvilleMC585.csv")
# write.csv(hwcount.df,
#           file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/DaysAbove90NelsonvilleMC585.csv")
...
write.csv(hwcount.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/TwoDayHWNelsonvilleEC585.csv")
# write.csv(hwcount.df,
#           file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/DaysAbove90NelsonvilleEC585.csv")
# ### MAKE BOXPLOT -----
# #setwd to get data
...
# 
# #read in csvs
# pul.hist <- read.csv("TwoDayHWNelsonvillehistorical.csv")
# pul.126MC <- read.csv("TwoDayHWNelsonvilleMC126.csv")
# pul.126EC <- read.csv("TwoDayHWNelsonvilleEC126.csv")
# pul.585MC <- read.csv("TwoDayHWNelsonvilleMC585.csv")
# pul.585EC <- read.csv("TwoDayHWNelsonvilleEC585.csv")
# 
...
#   ggtitle("Number of Two Day Heatwaes CMIP 6 models", subtitle="Nelsonville, OH (point extraction)") +
#   xlab("Timeframe and Emission Scenario") + 
#   ylab("Number of Two Day Heatwaves")
# bp
# 
# ggsave("~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/Boxplots/TwoDayHeatwaves/TwoDayHWBoxplot_Nelsonville.png",
#        plot=bp,
