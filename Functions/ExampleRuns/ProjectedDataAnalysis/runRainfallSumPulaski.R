...
write.csv(maxrain.df,
           file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallPulaskihistorical.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallPulaskiMC126.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallPulaskiEC126.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallPulaskiMC585.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallPulaskiEC585.csv")
