...
write.csv(maxrain.df,
           file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallNelsonvillehistorical.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallNelsonvilleMC126.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallNelsonvilleEC126.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallNelsonvilleMC585.csv")
...
write.csv(maxrain.df,
          file="~/2023/NEX-GDDP/Code_Larsson/Analysis/summary/GeneralSummaries/5DayRainfallNelsonvilleEC585.csv")
